...
const AboutUsPage = () => {
    ...
    useEffect (() => {
      setEditorHtml(`<p>Welcome to [Your Bus Company Name], your trusted partner for convenient and safe bus travel experiences. With a legacy of over [Number] years in the industry, we have been dedicated to providing exceptional service and memorable journeys to passengers of all backgrounds.</p>
