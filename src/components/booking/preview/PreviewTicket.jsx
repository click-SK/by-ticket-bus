						...
						<div className="invoice-logo-content">
							...
							<div className="bus-img">
								<svg width="363" height="140" viewBox="0 0 363 140" fill="none" xmlns="http://www.w3.org/2000/svg">
									...
									<path d="M97.0432 119.644C97.0432 121.736 96.4231 123.78 95.2612 125.519C94.0994 127.258 92.4479 128.613 90.5158 129.413C88.5837 130.214 86.4576 130.423 84.4065 130.015C82.3554 129.607 80.4713 128.6 78.9925 127.121C77.5137 125.642 76.5067 123.758 76.0987 121.707C75.6907 119.656 75.9001 117.53 76.7004 115.598C77.5007 113.666 78.856 112.014 80.5948 110.853C82.3337 109.691 84.3781 109.071 86.4694 109.071C89.2738 109.071 91.9633 110.185 93.9462 112.168C95.9292 114.151 97.0432 116.84 97.0432 119.644V119.644Z" stroke="#21242B" stroke-width="2" stroke-miterlimit="10"/>
									<path d="M92.5806 119.644C92.5806 120.853 92.2222 122.035 91.5506 123.04C90.8791 124.045 89.9247 124.828 88.808 125.291C87.6913 125.753 86.4625 125.874 85.277 125.638C84.0915 125.403 83.0026 124.82 82.1479 123.966C81.2932 123.111 80.7111 122.022 80.4753 120.837C80.2395 119.651 80.3606 118.422 80.8231 117.306C81.2857 116.189 82.069 115.235 83.074 114.563C84.079 113.892 85.2606 113.533 86.4693 113.533C88.0901 113.533 89.6445 114.177 90.7906 115.323C91.9367 116.469 92.5806 118.024 92.5806 119.644Z" stroke="#21242B" stroke-width="2" stroke-miterlimit="10"/>
									...
									<path d="M51.8888 6.71904C51.8888 6.71904 27.1746 13.6996 13.4017 32.1232C6.80649 40.9497 4.06445 51.6669 4.06445 63.4864V87.8601C4.06682 88.7268 4.41217 89.5573 5.02504 90.1702C5.63791 90.7831 6.46846 91.1284 7.33519 91.1308H9.56645C9.99859 91.1308 10.4264 91.045 10.8251 90.8783C11.2238 90.7116 11.5854 90.4673 11.8889 90.1597C12.1923 89.852 12.4317 89.4871 12.5929 89.0862C12.7542 88.6853 12.8342 88.2563 12.8282 87.8242C12.7745 83.4692 12.6938 75.4044 12.6938 67.2141C12.6938 52.9394 12.1113 47.5001 19.6744 33.2433C27.7392 17.9829 51.8888 6.71904 51.8888 6.71904Z" stroke="#21242B" stroke-width="2" stroke-miterlimit="10"/>
									<path d="M242.9 62.2767H332.366" stroke="#21242B" stroke-width="2" stroke-miterlimit="10"/>
									<path d="M251.054 71.0225H340.519" stroke="#21242B" stroke-width="2" stroke-miterlimit="10"/>
									<path d="M261.395 79.7773H350.86" stroke="#21242B" stroke-width="2" stroke-miterlimit="10"/>
								</svg>
							</div>
						</div>
					</header>
					...
					<div className="container">
						...
						<div className="invoice-timing-wrap">
							...
							<div className="invo-time-col">
								<div className="booking-info">
									<p className="second-color sm-md-text"><b className="w-text circle">Department Time: </b>{RDX_routeObject?.timeStart} AM</p>
						...
						<div className="bus-detail-wrap dark-bus-detail-wrap">
							...
							<div className="bus-detail-col seat-col">
								...
								<div className="bus-tname second-color inter-400 medium-font">A1, A2</div>
							</div>
							...
							<table className="invoice-table bus-detail-table">
								...
								<tbody className="invo-tb-body">
									<tr className="invo-tb-row">
										<td className="invo-tb-data">Delux Business Seat - 10:00 AM Sat</td>
								...
								<table className="invo-total-table">
									<tbody>
										<tr>
											...
											<td className="invo-total-data inter-400 medium-font second-color">$240.00</td>
										</tr>
										<tr className="tax-row bottom-border">
											...
											<td className="invo-total-data inter-400 medium-font second-color">$43.20</td>
										</tr>
										<tr className="invo-grand-total">
											<td className="inter-700 sm-text primary-color hotel-sub">Grand Total:</td>
											<td className="sm-text w-text invo-total-price">$283.20</td>
										</tr>
									</tbody>
								</table>
							</div>
